...
function Strategy(options, verify) {
  options = options || {};
  options.authorizationURL = options.authorizationURL || 'https://github.ibm.com/login/oauth/authorize';
  options.tokenURL = options.tokenURL || 'https://github.ibm.com/login/oauth/access_token';
  options.scopeSeparator = options.scopeSeparator || ',';
  options.customHeaders = options.customHeaders || {};

  if (!options.customHeaders['User-Agent']) {
    options.customHeaders['User-Agent'] = options.userAgent || 'passport-github-ibm';
  }

  OAuth2Strategy.call(this, options, verify);
  this.name = 'github.ibm.com';
  this._userProfileURL = options.userProfileURL || 'https://api.github.ibm.com/user';
...
Strategy.prototype.userProfile = function(accessToken, done) {
  ...
  this._oauth2.get(this._userProfileURL, accessToken, function (err, body, res) {
    ...
    profile.provider  = 'github.ibm.com';
    profile._raw = body;
    profile._json = json;
